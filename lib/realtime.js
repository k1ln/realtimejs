                ...
                else 
                {
                    ...
                    if(target[key] !== undefined || target[newkey]!==undefined)
                    {
                        if(key.substr(0,1)=="!")
                        {
                            ...
                            {
                                var funct = () => {return target[key].value;};
                ...
                if(typeof value == 'string')
                {
                   ...
                   // var value2 = value;
                    ...
                    else
                    {
                        ...
                        target[key].function = () => {return target[key].value;}    
                    }
...
var HTMLStyleAttributesArr = {
    ...
    class xtemplate extends HTMLElement {
        ...
        renderAfterTemplatesLoaded()
        {
            ...
            this.setAttribute("x-name",templatefile);
    ...
    /*class xrepeat extends HTMLElement {
        ...
        cleanListWhileArray()
        {
            var keys = Object.keys(XVARCLASS.Xvars_list_for_while_update);
            var iarr = 0;
            var Xlength = keys.length
        ...
        attributeChangedCallback(name, oldValue, newValue) {
            if(name == "data-x")
            {
                ...
                if (data!==undefined)
                {
                    ...
                    {
                        var d = this;
                        var str = this.before().outerHTML;
                        var webstring = '';
                        var idata = 0;
                        while(idata<datalength)
                        {
                            var propsstr = '';
                            propsstr = newValue + '[' + idata + ']'; 
                            webstr += str.replaceAll("props",propsstr) + '\n';
                            idata++;
                        }
                        this.innerHTML = webstr;
                    }
                } 
